...
const DataTableComponent = (props) => {
    ...
    const _handleSort = async (column, sortDirection) => {
        setRequestData({...requestData, sort_by:column.sortField, sort_directions: requestData.sort_directions==='asc' ? 'desc' : 'asc'})
    };
    ...
    React.useEffect(()=>{
        const _fetch = (data, options = {}) => {
            ...
            if(props.path){
                axios.get(props.path, {params:requestData}).then(res => {
