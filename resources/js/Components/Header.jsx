...
import {ChevronDownIcon, ChevronRightIcon} from "@heroicons/react/16/solid/index.js";
                        ...
                        {props.auth?.user
                            ?
                                <>
                                    <Menu as="div" className="relative inline-block text-left">
                                        ...
                                        >
                                            <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-[9999]">
                                                <div className="py-1">
                                                    <Menu.Item>
                                                        {({ active }) => (
                                                            <a
                                                    ...
                                                    {props.layout.settings_menu && props.layout.settings_menu.map((item,index)=>{
                                                        return <>
                                                            <Menu.Item>
                                                                {({ active }) => (
                                                                    <a
                            ...
                            :
                                <>
                                    ...
                                    <Link href={route('register', {trial:true})} className="text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-800 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none">Start trial</Link>
                                </>
                        }
                    </div>
                </nav>
                        ...
                        <div className="mt-6 flow-root">
                            <div className="-my-6 divide-y divide-gray-500/10">
                                <div className="space-y-2 py-6">
                                    <Link href="#" onClick={() => handleClick()} className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                                        Link 1
                                    </Link>
                                ...
                                <div className="py-6">
                                    {props.auth?.user
                                                    ...
                                                    <>
                                                        {props.layout?.sidebar_menu && props.layout?.sidebar_menu.map((item,index)=>{
                                                            if(item.name !== 'Dashboard'){
                                                                return <Link onClick={() => handleClick()} key={index} href={item.url} className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">{item.name}</Link>
                                                            }
                                                        })}
                                                            ...
                                                            {({ open }) => (
                                                                <>
                                                                    ...
                                                                    <Disclosure.Panel as="ul" className="mt-1 px-2">
                                                                        {props.layout.settings_menu.map((subItem) => (
                                                                            <li key={subItem.name}>
                                                                                <Disclosure.Button
                                                                                    as="a"
                                                                                    href={subItem.url}
                                        ...
                                        <>
                                            ...
                                            <Link href={route('register', {trial:true})} className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Start trial</Link>
                                        </>
                                    }
                                </div>
                            </div>
