...
export default function Index(props) {
  ...
  function deleteBreak(id) {
    router.delete(
      route("instructors.availability-breaks.destroy", {
        availability_break: id,
      }),
      {
        onSuccess: (page) => {},
        onError: (errors) => {},
        ...
        return (
          <>
            <div className="flex justify-between gap-3">
              <Link
                href={route("instructors.availability-breaks.edit", {
  ...
  return (
    <>
      ...
      <div className="flex justify-end mb-3">
        <Link
          href={route("instructors.availability-breaks.create")}
