    ...
    return (
        <>
            ...
            <div className="flex justify-end mb-3">
                <Link href={route('instructors.students.create')} className="text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none">Create new</Link>
            </div>
