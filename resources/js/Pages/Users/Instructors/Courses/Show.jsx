    ...
    return (
        <>
                                ...
                                <Menu.Item>
                                    {({ active }) => (
                                        <a
                                            ...
                                            onClick={() => setBookingInviteModal({'invitation_url': props.course.invitation_url, 'course_id': props.course.id})}
                                        >
                                            <PencilSquareIcon
                                ...
                                <Menu.Item>
                                    {({ active }) => (
                                        <a
                                            ...
                                            onClick={() => setStudentBookingModal({'course_id': props.course.id})}
            ...
            <Modal
                ...
                footer={
                    <div className='flex flex-col md:flex-row !justify-between items-center gap-2 w-full'>
                        <button type="button" onClick={()=>setStudentBookingModal(false)} className="_button white w-full md:w-auto min-w-[150px]">Cancel</button>
                        <a href={route('instructors.bookings-calendar', {'course_id': props.course.id, 'student_id': studentID})} className="_button white w-full md:w-auto min-w-[150px]">Go to booking</a>
                    </div>
                }
            />
