...
export default function Index(props) {
    ...
    function deleteBreak(id){
        router.delete(route('students.availability-breaks.destroy', {availability_break: id}), {
            onSuccess: (page) => {},
            onError: (errors) => {},
            preserveState: false,
                ...
                return(
                    <>
                        <div className="flex justify-between gap-3">
                            <Link href={route('students.availability-breaks.edit', {availability_break: row.id})} className="link">Edit</Link>
    ...
    return (
        <>
            ...
            <div className="flex justify-end mb-3">
                <Link href={route('students.availability-breaks.create')} className="text-white bg-primary hover:bg-primary-800 focus:ring-4 focus:ring-primary-800 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none">Add new break</Link>
            </div>
