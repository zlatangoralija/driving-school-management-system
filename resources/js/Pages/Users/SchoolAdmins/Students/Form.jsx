...
export default function CreateForm(props) {
  ...
  const submit = async () => {
    try {
      ...
      if (props.student) {
        router.put(
          route("school-administrators.students.update", {
    ...
    <>
      ...
      <div className="mx-auto mt-6 mb-10" ref={wrapperRef}>
        <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
          {props.student ? "Edit student" : "Create student"}
        </h1>
      ...
      <div className="grid grid-cols-0 md:grid-cols-0 gap-6">
        <Form ref={formRef} onSubmit={submit} className="card p-5 mb-3">
          ...
          <SelectDefault
            ...
            defaultValue={
              props.statuses && props.student
                ? props.statuses.find((x) => x.value === props.student.status)
                : props.statuses[0]
            }
