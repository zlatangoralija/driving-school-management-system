  ...
  return (
    <>
      ...
      <div className="flex md:justify-center justify-start w-full mb-8 gap-3 overflow-auto">
        ...
        <Link
          href={route("school-administrators.instructor-bookings", {
            instructor: props.instructor,
          })}
        >
        ...
        <Link
          href={route("school-administrators.instructor-courses", {
            instructor: props.instructor,
          })}
        >
      ...
      <DataTableComponent
        columns={columns}
        path={route("school-administrators.get-instructor-bookings", {
          instructor: props.instructor,
        })}
        search={search}
        object={"bookings"}
