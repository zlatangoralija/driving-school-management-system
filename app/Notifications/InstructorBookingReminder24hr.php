...
class InstructorBookingReminder24hr extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Reminder: Booking with ' . $this->booking->student->name . ' starts in 24 hours!')
            ->line('Your booking with ' . $this->booking->student->name . ' starts in 24 hours!')
