...
class AvailabilityBreakController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Users/Instructors/AvailabilityBreaks/Index');
    }

    public function getBreaks(Request $request){
        $data['breaks'] = AvailabilityBreak::with('instructor')
    ...
    public function create()
    {
        $breadcrumbs = [
            ...
            2 => [
                ...
                'url' => route('instructors.availability-breaks.create'),
                'active' => true,
            ],
        ];
        Inertia::share('layout.breadcrumbs', $breadcrumbs);
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('instructors.availability-breaks.index')
    ...
    public function edit(AvailabilityBreak $availabilityBreak)
    {
        $breadcrumbs = [
            ...
            2 => [
                ...
                'url' => route('instructors.availability-breaks.edit', ['availability_break' => $availabilityBreak]),
                'active' => true,
            ],
        ];
        Inertia::share('layout.breadcrumbs', $breadcrumbs);
